...
final quickActionsProvider = StateProvider<List<QuickActionItem>>((ref) {
  return [
    ...
    QuickActionItem(title: 'Schedule', iconPath: 'assets/icons/schedule.svg', route: '/schedule'),
    QuickActionItem(title: 'Attendance', iconPath: 'assets/icons/attendance.svg', route: '/attendance'),
  ];
});