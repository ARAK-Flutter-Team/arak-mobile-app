...
class StudentEvaluationPage extends ConsumerWidget {
    ...
    return Scaffold(
      ...
      body: studentAsync.when(
        ...
        data: (student) => SingleChildScrollView(
          ...
          child: Column(
            children: [
              _buildStudentCard(context, student, l10n),
  ...
  Widget _buildStudentCard(
      BuildContext context, Student student, AppLocalizations l10n) {
    final overallPercentage = student.overallScore.toStringAsFixed(0);
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style:
                AppTextStyles.textNormal.copyWith(fontWeight: FontWeight.w600),
          ),
          ...
          Row(children: [
            ...
            Container(
              ...
              child: Text(
                subject.rating,
                style:
                    AppTextStyles.textLabel.copyWith(color: Colors.green[700]),
              ),
            ),
          ]),
          const SizedBox(height: 10),
