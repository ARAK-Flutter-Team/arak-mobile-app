...
class _ConversationsListScreenState extends ConsumerState<ConversationsListScreen> {
      ...
      appBar: isSearching
        ...
        title: TextField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: isRtl ? null : Icon(Icons.search, size: 20, color: Colors.grey.shade500),
            suffixIcon: isRtl ? Icon(Icons.search, size: 20, color: Colors.grey.shade500) : null,
          ),
          style: TextStyle(
  ...
  Widget _buildConversationsList(
    ...
    return conversationsAsync.when(
      loading: () => Center(
        child: Column(
          ...
          children: [
            ...
            Text(loc.loading, style: TextStyle(color: Colors.grey.shade600)),
          ],
        ),
      ),
      error: (error, stack) => Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16.h),
            Text(loc.failedToLoadConversations, style: TextStyle(color: Colors.grey.shade600), textAlign: TextAlign.center),
            SizedBox(height: 8.h),
            TextButton(
      ...
      data: (conversations) {
        final filteredConversations = conversations.where((conv) => conv.otherPartyId != widget.currentUserId).toList();
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16.h),
            Text(loc.enterEmailToSearch, style: TextStyle(color: Colors.grey.shade600), textAlign: TextAlign.center),
          ],
        ),
      );
    }
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16.h),
                Text(loc.userNotFound, style: TextStyle(color: Colors.grey.shade600), textAlign: TextAlign.center),
              ],
            ),
          );
        }
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            if (item is Conversation) {
              return _buildConversationTile(item, theme, isDark, loc, isRtl);
            } else if (item is UserModel) {
              return _buildUserTile(item, theme, isDark, loc, isRtl);
            }
  ...
  Widget _buildConversationTile(
    ...
    return ListTile(
      leading: CircleAvatar(
        ...
        child: Text(
          conversation.otherPartyName.isNotEmpty ? conversation.otherPartyName[0].toUpperCase() : '?',
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16.h),
          Text(loc.noConversationsYet, style: TextStyle(color: Colors.grey.shade600), textAlign: TextAlign.center),
          SizedBox(height: 8.h),
          Text(loc.tapSearchToFindUser, style: TextStyle(color: Colors.grey.shade500), textAlign: TextAlign.center),
        ],
      ),
    );
  }
